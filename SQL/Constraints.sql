...
ALTER TABLE Events MODIFY Event_ID BIGINT AUTO_INCREMENT;

ALTER TABLE Complaint_Resolution MODIFY Resolution_ID BIGINT AUTO_INCREMENT;

ALTER TABLE Complaint MODIFY Complaint_ID BIGINT AUTO_INCREMENT;

ALTER TABLE Visitor_Entry MODIFY Visitor_ID BIGINT AUTO_INCREMENT;

ALTER TABLE Room_Allocation MODIFY Allocation_ID BIGINT AUTO_INCREMENT;

ALTER TABLE Lost_Item MODIFY Lost_ID BIGINT AUTO_INCREMENT;

ALTER TABLE Item MODIFY Item_ID BIGINT AUTO_INCREMENT;